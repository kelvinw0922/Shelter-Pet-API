...
function fetchAnimals(e) {
  e.preventDefault(); // Collect User Input
  ...
  (0, _fetchJsonp.default)("https://api.petfinder.com/pet.find?format=json&key=30d4039bc0d0ed9e15820ef807aeab0b&animal=".concat(animal, "&location=").concat(zip, "&callback=callback"), {
...
function showAnimals(pets) {
  ...
  pets.forEach(function (pet) {
    ...
    div.innerHTML = "\n        <div class=\"row\">\n            <div class=\"col-sm-6\">\n                <h4>".concat(pet.name.$t, " (").concat(pet.age.$t, ")</h4>\n                <p class=\"text-seconday\">").concat(pet_breed, "</p>\n                <p>").concat(pet_address1, " ").concat(pet.contact.city.$t, " ").concat(pet.contact.state.$t, " ").concat(pet.contact.zip.$t, "</p>\n                <ul class=\"list-group\">\n                    <li class=\"list-group-item\">Phone: ").concat(pet_phone, "</li>\n                    ").concat(pet.contact.email.$t ? "<li class=\"list-group-item\">E-Mail: ".concat(pet.contact.email.$t, "</li>") : "", "\n                    <li class=\"list-group-item\">Shelter ID: ").concat(pet.shelterId.$t, "</li>\n                </ul>\n            </div>\n            <div class=\"col-sm-6 text-center\">\n                <img class=\"img-fluid mt-2\" src=\"").concat(pet.media.photos.photo[3].$t, "\">\n            </div>\n        </div>\n    ");
