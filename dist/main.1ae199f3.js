...
function fetchAnimals(e) {
  ...
  (0, _fetchJsonp2.default)("https://api.petfinder.com/pet.find?format=json&key=30d4039bc0d0ed9e15820ef807aeab0b&animal=" + animal + "&location=" + zip + "&callback=callback", { jsonpCallbackFunction: "callback" }).then(function (res) {
    return res.json();
  }).then(function (data) {
...
//# sourceMappingURL=/main.1ae199f3.map